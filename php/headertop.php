...
<html class="no-js" lang="">
    <head>
        ...
        <meta name="description" content="University of Prishtina">
		<meta name="author" content="Doresa and Eriona">
				...
				<div class="menu ">
					...
					<ul>
						...
						<?php if($user->get_faculty_session()){ ?>
								...
								<li><a href="teacher.php"><i class="fa fa-cog" aria-hidden="true">Gradeing</i>
